...
import dev.liinahamari.suggestions.impl.usecases.GetMovieGenresUseCaseImpl
...
interface UseCaseModule {
    ...
    @Binds
    @Singleton
    fun getMovieGenresUseCase(impl: GetMovieGenresUseCaseImpl): GetMovieGenresUseCase
